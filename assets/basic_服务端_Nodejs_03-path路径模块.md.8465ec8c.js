import{_ as s,o as a,c as n,V as e}from"./chunks/framework.f3592640.js";const m=JSON.parse('{"title":"path 路径模块","description":"","frontmatter":{},"headers":[],"relativePath":"basic/服务端/Nodejs/03-path路径模块.md","filePath":"basic/服务端/Nodejs/03-path路径模块.md"}'),l={name:"basic/服务端/Nodejs/03-path路径模块.md"},t=e(`<h1 id="path-路径模块" tabindex="-1">path 路径模块 <a class="header-anchor" href="#path-路径模块" aria-label="Permalink to &quot;path 路径模块&quot;">​</a></h1><ul><li><p>a. 导入：<code>const path = require(&#39;path&quot;)</code></p></li><li><p>b. 基本方法</p><ul><li><p>ⅰ. <code>path.join()</code> 路径拼接，(特殊用法： <code>../</code> 会抵消一层路径)</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const pathStr = path.join(&#39;/a&#39;, &#39;/b/c&#39;, &#39;../&quot;, &#39;./d&#39;, &#39;e&#39;)</span></span>
...
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div></li></ul></li></ul>`,2),p=[t];function o(c,i,r,d,h,C){return a(),n("div",null,p)}const u=s(l,[["render",o]]);export{m as __pageData,u as default};
